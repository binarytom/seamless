...
mod test {
    ...
    fn serialize() {
        ...
        let bytes: Vec<u8> = vec![0, 0, 0, 0, 12, 0, 0, 0, 0, 0, 0, 0, 72, 101, 108, 108, 111, 32, 87, 111, 114, 108, 100, 33];
        assert_eq!(bytes, serialized);
    }

    #[test]
    fn deserialize() {
        let serialized: Vec<u8> = vec![0, 0, 0, 0, 12, 0, 0, 0, 0, 0, 0, 0, 72, 101, 108, 108, 111, 32, 87, 111, 114, 108, 100, 33];
